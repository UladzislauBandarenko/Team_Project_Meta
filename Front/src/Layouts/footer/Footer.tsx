      ...
      <div className="footer__content">
        ...
        <div className="footer__section">
          ...
          <ul className="footer__links">
            <li>
              <Link to="/shop/dog">Dog Products</Link>
            </li>
            <li>
              <Link to="/shop/cat">Cat Products</Link>
            </li>
            <li>
              <Link to="/shop/fish">Fish Products</Link>
            </li>
            <li>
              <Link to="/shop/bird">Bird Products</Link>
            </li>
            <li>
              <Link to="/shop/small-pets">Small Pets</Link>
            </li>
            <li>
              <Link to="/shop/reptile">Reptile Products</Link>
            </li>
          </ul>
        </div>
        ...
        <div className="footer__section">
          ...
          <ul className="footer__links">
            ...
            <li>
              <Link to="/shelters">Partner Shelters</Link>
            </li>
          </ul>
        </div>
