    ...
    return (
        <div className="signup-page">
            <div className="signup-page__container">
                <Link to="/" className="signup-page__back">← Back to Home</Link>
                ...
                <div className="signup-page__content">
                    ...
                    <form className="signup-page__form" onSubmit={handleSubmit}>
                        ...
                        <div className="form-group">
                            <label className="checkbox-label">
                                ...
                                />
                                <span className="checkbox-text">
                                    I agree to the <Link to="/privacy" className="terms-link">Privacy Policy</Link>
                                </span>
                            </label>
                    ...
                    <div className="signup-page__footer">
                        Already have an account? <Link to="/login" className="signup-page__login-link">Sign in</Link>
                    </div>
                </div>
            </div>
        </div>
