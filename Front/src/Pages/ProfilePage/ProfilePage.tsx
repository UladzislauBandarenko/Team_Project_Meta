...
const mockOrders: Order[] = [
  { id: "ORD-12345", date: "2025-05-01", status: "Delivered", total: 124.97 },
  { id: "ORD-12344", date: "2025-04-15", status: "Delivered", total: 89.99 },
  { id: "ORD-12343", date: "2025-03-28", status: "Delivered", total: 94.98 },
]
                ...
                {mockOrders.map((order) => (
                  <div key={order.id} className="order-item">
                    ...
                    <div className="order-item__details">
                      ...
                      <div className="order-item__total">Total: €{order.total}</div>
                    </div>
                  </div>
                ))}
              </div>
